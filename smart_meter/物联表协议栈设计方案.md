...
![图片](https://cdn.jsdelivr.net/gh/Dong7777/learning@main/smart_meter/media/image1.png)

客户机对服务器上报的响应：

![图片](https://cdn.jsdelivr.net/gh/Dong7777/learning@main/smart_meter/media/image2.png)

客户机发起的请求：

![图片](https://cdn.jsdelivr.net/gh/Dong7777/learning@main/smart_meter/media/image3.png)

服务器对客户机请求的响应：

![图片](https://cdn.jsdelivr.net/gh/Dong7777/learning@main/smart_meter/media/image4.png)

##### 2.2.3.3分帧标志位

分帧标志位:bit5=0，表示此帧链路用户数据为完整APDU；bit5=1，表示此帧链路用户数据为APDU片段。

![图片](https://cdn.jsdelivr.net/gh/Dong7777/learning@main/smart_meter/media/image5.png)
...
![图片](https://cdn.jsdelivr.net/gh/Dong7777/learning@main/smart_meter/media/image6.png)

开启扰码请求报文：

![图片](https://cdn.jsdelivr.net/gh/Dong7777/learning@main/smart_meter/media/image7.png)

回复对比：

![图片](https://cdn.jsdelivr.net/gh/Dong7777/learning@main/smart_meter/media/image8.png)
...
![图片](https://cdn.jsdelivr.net/gh/Dong7777/learning@main/smart_meter/media/image9.png)
...
![图片](https://cdn.jsdelivr.net/gh/Dong7777/learning@main/smart_meter/media/image10.png)
...
![图片](https://cdn.jsdelivr.net/gh/Dong7777/learning@main/smart_meter/media/image11.png)

有扩展逻辑地址

![图片](https://cdn.jsdelivr.net/gh/Dong7777/learning@main/smart_meter/media/image12.png)
...
![图片](https://cdn.jsdelivr.net/gh/Dong7777/learning@main/smart_meter/media/image13.png)

###### 2.2.4.2.5广播地址

广播地址的长度固定为1字节，广播地址=AAH。广播地址对系统所有服务器有效，无需应答。

![图片](https://cdn.jsdelivr.net/gh/Dong7777/learning@main/smart_meter/media/image14.png)
...
![图片](https://cdn.jsdelivr.net/gh/Dong7777/learning@main/smart_meter/media/image15.png)

b) 分帧传输确认，分帧类型=2，block值为最近一次收到正确的帧序号；

![图片](https://cdn.jsdelivr.net/gh/Dong7777/learning@main/smart_meter/media/image16.png)

c) 分帧的发送方在接收到确认帧后传输下一个数据帧，分帧类型=3，分帧序号block=接收到确认帧的帧序号+1，重复b)和c)；

![图片](https://cdn.jsdelivr.net/gh/Dong7777/learning@main/smart_meter/media/image17.png)

确认帧帧号+1：

![图片](https://cdn.jsdelivr.net/gh/Dong7777/learning@main/smart_meter/media/image18.png)

d) 分帧的最后一帧，block=最后一帧的帧序号，分帧类型=1，发送方在接收到最后一个确认帧后，分帧传输过程完成。

![图片](https://cdn.jsdelivr.net/gh/Dong7777/learning@main/smart_meter/media/image19.png)

最后一帧回复：

![图片](https://cdn.jsdelivr.net/gh/Dong7777/learning@main/smart_meter/media/image20.png)
...
![图片](https://cdn.jsdelivr.net/gh/Dong7777/learning@main/smart_meter/media/image21.png)

回复帧：

![图片](https://cdn.jsdelivr.net/gh/Dong7777/learning@main/smart_meter/media/image22.png)

断开应用连接：

![图片](https://cdn.jsdelivr.net/gh/Dong7777/learning@main/smart_meter/media/image23.png)

ESAM回抄表号：

![图片](https://cdn.jsdelivr.net/gh/Dong7777/learning@main/smart_meter/media/image24.png)

回复帧：

![图片](https://cdn.jsdelivr.net/gh/Dong7777/learning@main/smart_meter/media/image25.png)
...
![图片](https://cdn.jsdelivr.net/gh/Dong7777/learning@main/smart_meter/media/image26.png)
...
![图片](https://cdn.jsdelivr.net/gh/Dong7777/learning@main/smart_meter/media/image27.png)

#### 4.1.2 判断APDU数据格式

![图片](https://cdn.jsdelivr.net/gh/Dong7777/learning@main/smart_meter/media/image28.png)

#### 4.1.3 处理APDU数据

![图片](https://cdn.jsdelivr.net/gh/Dong7777/learning@main/smart_meter/media/image29.png)

4.1.4 内部抄读接口

![图片](https://cdn.jsdelivr.net/gh/Dong7777/learning@main/smart_meter/media/image30.png)
